...
string_file_path <- "String/N2/N2_unique_enrichment.all.tsv"
...
neural <- neural %>%
  select(`term ID`, `term description`, `Gene Name`, `RS3_3D_N2_vs_RS3_3D_DMEM_log2 fold change`, `RS3_3D_N2_vs_RS3_3D_DMEM_significant`) %>%
