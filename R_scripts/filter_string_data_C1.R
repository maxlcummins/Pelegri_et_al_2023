...
string_file_path <- "String/C1/C1_unique_enrichment.all.tsv"
...
neural <- neural %>%
  select(`term ID`, `term description`, `Gene Name`, `RS2_3D_C1_vs_RS2_3D_DMEM_log2 fold change`, `RS2_3D_C1_vs_RS2_3D_DMEM_significant`) %>%
