...
#Change here
treatment_name <- "B27_C1"

#Change here
#Define string file path
string_file_path <- "String/B27_C1/B27_C1_enrichment.all.tsv"
...
neural <- neural %>%
  select(`term ID`, `term description`, `Gene Name`, `RS2_3D_B27_vs_RS2_3D_DMEM_log2 fold change`, `RS2_3D_B27_vs_RS2_3D_DMEM_significant`, `RS2_3D_C1_vs_RS2_3D_DMEM_log2 fold change`, `RS2_3D_C1_vs_RS2_3D_DMEM_significant`) %>%
