...
string_file_path <- "Treatments_3D_DMEM_3D/String/B27/B27_unique_enrichment.all.tsv"
...
neural <- neural %>%
  select(`term ID`, `term description`, `Gene Name`, `RS2_3D_B27_vs_RS2_3D_DMEM_log2 fold change`, `RS2_3D_B27_vs_RS2_3D_DMEM_significant`) %>%
