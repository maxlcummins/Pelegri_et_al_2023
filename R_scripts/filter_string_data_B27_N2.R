...
#Change here
treatment_name <- "B27_N2"

#Change here
#Define string file path
string_file_path <- "String/B27_N2/B27_N2_enrichment.all.tsv"
...
neural <- neural %>%
  select(`term ID`, `term description`, `Gene Name`, `RS2_3D_B27_vs_RS2_3D_DMEM_log2 fold change`, `RS2_3D_B27_vs_RS2_3D_DMEM_significant`, `RS3_3D_N2_vs_RS3_3D_DMEM_log2 fold change`, `RS3_3D_N2_vs_RS3_3D_DMEM_significant`) %>%
